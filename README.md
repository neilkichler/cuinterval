...
[![DOI](https://img.shields.io/badge/doi-10.5281/zenodo.15813967-blue?logo=doi)](https://doi.org/10.5281/zenodo.15813967)
...
```bash
wget https://github.com/neilkichler/cuinterval/releases/download/v0.4.1/cuinterval.cuh
```
...
```cmake
CPMAddPackage("gh:neilkichler/cuinterval@0.4.1")
```
